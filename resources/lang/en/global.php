...
return [
    ...
    'server_status_front_title'            => 'CWB Server Status Page',
    'misc_title'                           => 'Misc',
    'email_list_title'                     => 'Email List',
    'email_list_desc'                      => 'Recipient who receive alert notifications. Separated by comma(,) for multiple emails.',
    'alert_calming_msg'                    => 'Announcement',
    'alert_calming_msg_desc'               => 'Set the custom alert message while one of the service is maintenance or down',
    'service_maintenance_title'            => 'MAINTENANCE',
    'service_maintenance_desc'             => 'Service is under maintenance.',
    'service_busy_title'                   => 'BUSY',
    'service_busy_desc'                    => 'Service is busy. It may cause a delay on commits.',
    'service_up_title'                     => 'UP',
    'service_up_desc'                      => 'Service is active and usable.',
    'server_status_update_ask'             => 'Confirm update server status?',
    'server_status_update_success'         => 'Server Status Update Successful',
    'email_list_update_ask'                => 'Confirm update email list?',
    'email_list_update_success'            => 'Email List Update Successful',
    'calming_msg_update_ask'               => 'Confirm update alert message?',
    'calming_msg_update_success'           => 'Alert Message Update Successful',
    'go_to_status_page'                    => 'Go to STATUS PAGE',
    'last_check_on'                        => 'Last checked on',
    'changes_on_server_title'              => 'Changes on Server Status',
    'date_time_title'                      => 'Date Time',
    'server_name_title'                    => 'Server Name',
    'status_legend_title'                  => 'Status Legend',
    'dashboard_title'                      => 'Dashboard',
    'dashboard_welcome_user'               => 'Greetings :username.',
    'dashboard_welcome_msg'                => 'Please choose the options on the left bar to begin.',
    'back'                      => 'Back',
    ...
    'quantity'                  => 'Quantity',
    'price_include_vat'         => 'Price (VAT included)',
    ...
    'intent_id'                 => 'Intent ID',
    'payment_method_types'      =>'Payment Type',
    'payment_status'             =>'Status',
    'tax'                       =>'Sales tax',
    'grand_total'               =>'Grand total',
    'invoice'                   =>'Invoice',
    'misc'                      =>'Miscellaneous ',
    'postal_resend_charges'     =>'Postal Resend Charges ',
    'payment_tax_id'             =>'Tax ID ',
];
